...
server <- function(input, output, session) {
  ...
  # randomNumber11 <- reactiveVal(0)
  
  # observeEvent(eventExpr = input$newHand, 
  #              handlerExpr = {randomNumber11 <- randomNumber11(sample(1:9, 1))})
  # handPicker <- as.numeric(randomNumber11())
  
  ##############################################
  
  # randomNumber11 <- reactiveVal(0)
  # observeEvent(eventExpr = input$newHand, 
  #              handlerExpr = {randomNumber11 <- sample(1:9, 1)})
  # handPicker <- as.integer(randomNumber11)
  
  ##############################################
  
  # handpicker <- eventReactive(eventExpr = input$newHand, 
  #               valueExpr = sample(1:9, 1)
  #               )
  ...
  #   handlerExpr = {
  #     if (!is.null(randomNumber11)) {
  #       handPicker <- sample((1:9), 1)
  #     }
  #   }
  # )
  ...
  #   observeEvent(
  #     eventExpr = input$newHand,
  #     handlerExpr = {handPicker <- sample((1:9), 1)
  #     if (randomNumber11 < 10) {
  #       handPicker <- as.numeric(randomNumber11)
  #     }}
  #   )
  ...
  handPicker <- reactive({sample((1:9), 1)})
