          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              tags$ul(
                ...
                tags$li("Answer: \\(\\dfrac{5\\cdot[_{3}C_{2}+3\\cdot(3\\cdot)]\\cdot{3}!}
              ...
              tags$ul(
                ...
                tags$li("Answer: \\(_{5\\cdot[_{3}C_{2}+3\\cdot(3\\cdot4)]\\cdot3}C_{5}\\)"), ##Answer
                tags$li("\\(_{5\\cdot[_{3}C_{2}+3\\cdot(3\\cdot4)]\\cdot3}P_{5}\\)"), 
